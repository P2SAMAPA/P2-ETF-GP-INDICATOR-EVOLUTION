...
def build_primitive_set(feature_names):
    ...
    # Terminal constants – fix ephemeral warning
    ...
    for fold in range(n_folds):
        ...
        for row in X_fold:
            try:
                ...
                signals.append(0.5)   # neutral if any math error
...
def run_gp_for_window(ticker, returns_df, macro_df, train_test_pairs):
    ...
    # Reset DEAP creator to avoid duplicate definitions
    try:
